...
IF(WITH_OPENNI)
  ...
  IF(NOT OPENNI_INCLUDE_DIR OR NOT OPENNI_LIBRARY)
    MESSAGE(FATAL_ERROR "WITH_OPENNI=ON, but OpenNI was not found in the configured target sysroot or explicit roots.")
  ENDIF()

  infinitam_add_imported_dependency(InfiniTAMDependency::OpenNI
    INCLUDES "${OPENNI_INCLUDE_DIR}"
    LIBRARIES "${OPENNI_LIBRARY}"
  )
ELSE()
